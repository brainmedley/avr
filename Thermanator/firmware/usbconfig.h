/* Name: usbconfig.h
 * Project: TestLogger based on V-USB, virtual USB port for Atmel's(r) AVR(r) microcontrollers
 * Author: Ben Holt (Modified from Christian Starkjohann)
 * Creation Date: 2009-08-12
 * Tabsize: 4
 * Copyright: (c) 2009 by Ben Holt
 * License: GNU GPL v2 (see License.txt -- "Free as in herpes")
 ...
 */
#define USB_CFG_VENDOR_NAME     'b', 'r', 'a', 'i', 'n', 'm', 'e', 'd', 'l', 'e', 'y', '.', 'c', 'o', 'm'
...
if __name__ == "__main__":
  print ", ".join([ "'%s'" % c for c in sys.argv[1] ])
  print len(sys.argv[1])
 */
#define USB_CFG_DEVICE_NAME     'T', 'e', 's', 't', 'L', 'o', 'g', 'g', 'e', 'r'
